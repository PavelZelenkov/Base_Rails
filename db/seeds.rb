...
rules = Rule.create!([
  {title: 'Правило применимое к категории backend'},
  {title: 'Правило применимое к категории frontend'},
  {title: 'Правило применимое к категории mobile development'},
  {title: 'Правило применимое к легким тестам (от 0...1)'},
  {title: 'Правило применимое к средней сложности тестам (от 2...4)'},
  {title: 'Правило применимое к сложным тестам (от 5 и выше)'},
  {title: 'Правило применимое ко всем тестам'}
])
