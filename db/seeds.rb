...
conditions = Condition.create!([
  {title: 'first_test'}, # метод за прохождение теста с первой попытки
  {title: 'first_attempt'}, # за прохождение теста
  {title: 'all_in_level'}, #  за прохождение теста определенного левела
  {title: 'all_in_category'} # бейдж за прохождение теста определенной категории
])
