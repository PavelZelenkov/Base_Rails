...
categories = Category.create([
  ...
  {title: 'Frontend', user_id: users.first.id},
...
tests = Test.create([
  ...
  {title: 'CSS', level: 1, category_id: categories.first.id},
...
questions = Question.create([
  ...
  {body: 'Вопрос 2', test_id: tests.first.id},
  {body: 'Вопрос 3', test_id: tests.first.id},
  {body: 'Вопрос 4', test_id: tests.last.id},
  {body: 'Вопрос 5', test_id: tests.last.id},
  {body: 'Вопрос 6', test_id: tests.last.id}
])

answers = Answer.create([
  {body: 'Ответ 1', correct: 1, question_id: questions.first.id},
  {body: 'Ответ 2', correct: 1, question_id: questions.first.id},
  {body: 'Ответ 3', correct: 1, question_id: questions.first.id},
  {body: 'Ответ 4', correct: 1, question_id: questions.last.id},
  {body: 'Ответ 5', correct: 1, question_id: questions.last.id},
